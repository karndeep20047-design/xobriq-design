...
//  ---------------------------------------------------------------------------
//  - Interactive scroll reveal curtain effect via sticky CSS positioning
...
export function Footer() {
  return (
    <footer className="sticky bottom-0 -z-10 w-full bg-slate-50 dark:bg-[#070708] border-t border-slate-200/80 dark:border-zinc-800/80 transition-colors duration-150">
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8">
        
        {/* Top Grid Area */}
        <div className="grid gap-12 lg:grid-cols-12 pb-12 border-b border-slate-200/80 dark:border-zinc-800/60">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between space-y-6">
            <div>
              ...
              />
              <h3 className="mt-6 text-xl font-bold tracking-tight text-slate-900 dark:text-white leading-snug">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="rounded-lg border border-slate-300 dark:border-zinc-700 hover:border-slate-400 dark:hover:border-zinc-500 bg-transparent px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-slate-800 dark:text-zinc-200 transition-colors"
              >
                Contact Sales
              </Link>
              <Link
                href="/register"
                className="rounded-lg bg-slate-900 dark:bg-zinc-100 hover:bg-slate-800 dark:hover:bg-white px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-white dark:text-black transition-colors"
              >
                Sign Up Free
              </Link>
            </div>

            <div className="space-y-2 text-xs text-slate-500 dark:text-zinc-400">
