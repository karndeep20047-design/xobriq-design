        ...
        <div className="mt-8 sm:mt-10">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="overflow-hidden rounded-3xl border border-blue-200/90 dark:border-blue-900/50 bg-white/90 dark:bg-[#0B1224]/90 shadow-xl dark:shadow-2xl backdrop-blur-md grid lg:grid-cols-12 gap-0"
            >
