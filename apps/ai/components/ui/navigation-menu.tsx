...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDownIcon
      className="relative top-[1px] ml-1 h-3.5 w-3.5 transition duration-300 group-data-[state=open]:rotate-180 opacity-70"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
